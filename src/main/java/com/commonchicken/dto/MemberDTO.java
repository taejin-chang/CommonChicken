...
public class MemberDTO {
	...
	public String getMemAuthCode() {
		return memAuthCode;
	}

	public void setMemAuthCode(String memAuthCode) {
		this.memAuthCode = memAuthCode;
	}
	...
	public String getMemUpload() {
		return memUpload;
	}

	public void setMemUpload(String memUpload) {
