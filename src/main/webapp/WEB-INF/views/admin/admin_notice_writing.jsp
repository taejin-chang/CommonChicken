                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" >
                    <div class="form-group row" style="margin-bottom: 0;">
                      ...
                      <div class="col-sm-10" >
                        <input type="text" class="form-control" style="width: 500px; display: inline;" id="exampleInputUsername2" placeholder="제목을 입력해주세요.">
                      	<input type="checkbox" style="display: inline;" name="noticeStatus" value="2">필독 
                      </div>
                    </div>
                    <div class="form-group row" style="margin-bottom: 0;">
                      ...
                      <div class="col-sm-10" style="padding-top: 15px;">
                      	홍길동
<!--                         <input type="email" class="form-control" style="width: 300px;" id="exampleInputEmail2" placeholder="Email">
 -->                      </div>
                    </div>
                    <div class="form-group row" style="margin-bottom: 0;">
                    ...
                    <div class="form-group row" >
                      ...
                      <textarea class="form-control" id="exampleTextarea1" rows="25"></textarea>
                   	...
                   	<div style="text-align: right;">
                    	...
                    	<button class="btn btn-w">취소</button>
                  	</div>
                  </form>
                </div>
              </div>
