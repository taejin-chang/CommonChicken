                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" id="data" enctype="multipart/form-data" >
                    <input type="hidden" name="brdNum" value="${noticeModify.brdNum}">
                      ...
                      <div class="col-sm-10" >
                        <input type="text" class="form-control" style="width: 50%; display: inline;" name="brdTitle" id="brdTitle" value="${noticeModify.brdTitle}" placeholder="제목을 입력해주세요.">
                      </div>
                    </div>
                    <div class="form-group row" style="margin-bottom: 0;">
                    ...
                    <div class="form-group row" >
                      ...
                      <div class="col-sm-10" >
                      <textarea class="form-control" id="brdContent" rows="25" name="brdContent">${noticeModify.brdContent}</textarea>
                      </div>
                    </div>
