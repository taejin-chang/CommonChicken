...
①고객님은 개인정보 수집 및 이용에 동의하지 않을 권리가 있습니다. 다만, 서비스에 필수적인 동의이므로 거부 할 경우 서비스 이용이 불가합니다.
							...
							<button type="button" id="alarm" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal">알림</button>
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      ...
							      <div class="modal-footer">
							        ...
							        <button type="button" class="btn btn-primary" id="notifySendBtn">Send message</button>
							      </div>
							    </div>
							  </div>
							</div>
